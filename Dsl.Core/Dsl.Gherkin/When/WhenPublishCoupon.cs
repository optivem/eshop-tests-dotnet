...
namespace Optivem.EShop.SystemTest.Dsl.Gherkin.When;

public class PublishCouponBuilder : BaseWhenBuilder<VoidValue, Driver.Core.Driver.Commons.Dsl.VoidVerification>
{
