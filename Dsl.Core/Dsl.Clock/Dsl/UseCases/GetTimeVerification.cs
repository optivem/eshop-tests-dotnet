...
public class GetTimeVerification : Driver.Core.Driver.Commons.Dsl.ResponseVerification<GetTimeResponse>
{
    public GetTimeVerification(GetTimeResponse response, Driver.Core.Driver.Commons.Dsl.UseCaseContext context)
