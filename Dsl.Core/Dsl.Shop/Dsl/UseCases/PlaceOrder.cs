...
public class PlaceOrder : BaseShopCommand<PlaceOrderResponse, PlaceOrderVerification>
{
    ...
    public PlaceOrder(IShopDriver driver, Driver.Core.Driver.Commons.Dsl.UseCaseContext context)
        : base(driver, context)
    {
    }
    ...
    public override async Task<ShopDriver.Core.Driver.Commons.Dsl.UseCaseResult<PlaceOrderResponse, PlaceOrderVerification>> Execute()
    {
        ...
        return new ShopDriver.Core.Driver.Commons.Dsl.UseCaseResult<PlaceOrderResponse, PlaceOrderVerification>(
            result,
            _context,
