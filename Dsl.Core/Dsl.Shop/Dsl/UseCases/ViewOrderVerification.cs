...
public class ViewOrderVerification : Driver.Core.Driver.Commons.Dsl.ResponseVerification<ViewOrderResponse>
{
    public ViewOrderVerification(ViewOrderResponse response, Driver.Core.Driver.Commons.Dsl.UseCaseContext context)
