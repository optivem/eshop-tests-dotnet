...
public class SystemErrorFailureVerification : Driver.Core.Driver.Commons.Dsl.ResponseVerification<SystemError>
{
    public SystemErrorFailureVerification(SystemError error, Driver.Core.Driver.Commons.Dsl.UseCaseContext context)
        : base(error, context)
    {
    }
