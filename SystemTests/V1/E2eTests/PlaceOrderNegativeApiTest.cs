...
public class PlaceOrderNegativeApiTest : BaseE2eTest
{
    ...
    {
        var placeOrderJson = $$"""{"sku":"{{CreateUniqueSku(Defaults.SKU)}}","quantity":"invalid-quantity","country":"{{Defaults.COUNTRY}}"}""";
    ...
    {
        var placeOrderJson = $$"""{"sku":"NON-EXISTENT-SKU-12345","quantity":"{{Defaults.QUANTITY}}","country":"{{Defaults.COUNTRY}}"}""";
        var (statusCode, body) = await PlaceOrderViaApiAsync(placeOrderJson);
    ...
    {
        var placeOrderJson = $$"""{"sku":"{{CreateUniqueSku(Defaults.SKU)}}","quantity":"-10","country":"{{Defaults.COUNTRY}}"}""";
        var (statusCode, body) = await PlaceOrderViaApiAsync(placeOrderJson);
    ...
    {
        var placeOrderJson = $$"""{"sku":"{{CreateUniqueSku(Defaults.SKU)}}","quantity":"0","country":"{{Defaults.COUNTRY}}"}""";
        var (statusCode, body) = await PlaceOrderViaApiAsync(placeOrderJson);
        AssertValidationError(statusCode, body, "quantity", "Quantity must be positive");
    }
    ...
    {
        var placeOrderJson = $$"""{"sku":"","quantity":"{{Defaults.QUANTITY}}","country":"{{Defaults.COUNTRY}}"}""";
        var (statusCode, body) = await PlaceOrderViaApiAsync(placeOrderJson);
    ...
    {
        var placeOrderJson = $$"""{"sku":"{{CreateUniqueSku(Defaults.SKU)}}","quantity":"{{Defaults.QUANTITY}}","country":""}""";
        var (statusCode, body) = await PlaceOrderViaApiAsync(placeOrderJson);
        AssertValidationError(statusCode, body, "country", "Country must not be empty");
    }
    ...
    {
        var placeOrderJson = $$"""{"sku":"{{CreateUniqueSku(Defaults.SKU)}}","country":"{{Defaults.COUNTRY}}","quantity":null}""";
        var (statusCode, body) = await PlaceOrderViaApiAsync(placeOrderJson);
        AssertValidationError(statusCode, body, "quantity", "Quantity must not be empty");
    }
    ...
    {
        var placeOrderJson = $$"""{"sku":null,"quantity":"{{Defaults.QUANTITY}}","country":"{{Defaults.COUNTRY}}"}""";
        var (statusCode, body) = await PlaceOrderViaApiAsync(placeOrderJson);
        AssertValidationError(statusCode, body, "sku", "SKU must not be empty");
    }
    ...
    {
        var placeOrderJson = $$"""{"sku":"{{CreateUniqueSku(Defaults.SKU)}}","quantity":"{{Defaults.QUANTITY}}","country":null}""";
        var (statusCode, body) = await PlaceOrderViaApiAsync(placeOrderJson);
        AssertValidationError(statusCode, body, "country", "Country must not be empty");
    }
